...
%        \frametitle{Appendix}
    ...
    \begin{frame}[shrink = 5, allowframebreaks, noframenumbering]
        ...
        \input{tbl_sdid_mechanism_onsite_waste_mgt}
    ...
    \begin{frame}[shrink = 20, allowframebreaks, noframenumbering]
        ...
        \input{tbl_sdid_mechanism_onsite_sra}
    ...
    \begin{frame}[shrink = 3, allowframebreaks, noframenumbering]
        ...
        \input{tbl_sdid_mechanism_onsite_sra_matsub_prod}
    ...
    \begin{frame}[shrink = 3, allowframebreaks, noframenumbering]
        ...
        \input{tbl_sdid_mechanism_onsite_sra_process}
