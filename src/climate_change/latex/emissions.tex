...
%    \input{tbl_summ_onsite_mechanisms}
    ...
    \input{tbl_did_baseline_tot_onsite_releases_int}
    ...
    \input{fig_did_total_releases_onsite_int}
    ...
    \input{tbl_did_baseline_onsite_air_emissions_int}
    ...
    \input{fig_did_total_onsite_air_emissions_int}
    ...
    \input{tbl_did_baseline_onsite_water_discharge_int}
    \input{fig_did_total_onsite_water_discharge_int}
    ...
    \input{tbl_did_baseline_onsite_land_releases_int}
    ...
    \input{fig_did_total_onsite_land_releases_int}


%    \section{Offsite and POTWs Toxic Releases}\label{sec:offsite-and-potws-toxic-releases}
%    \input{fig_did_offsite_total_releases_int}
...
%    \input{fig_did_potws_total_releases}
    ...
    \end{equation}
    \input{tbl_did_robustness_placebo}
    ...
    \input{tbl_did_robustness_total_releases_int_onsite}
    \input{tbl_did_robustness_onsite_air_emissions_int}
    \input{tbl_did_robustness_onsite_water_releases_int}
    \input{tbl_did_robustness_onsite_land_releases_int}
    ...
    \input{tbl_did_heter_onsite_releases_int_GDP}
    ...
    \input{fig_did_heter_onsite_releases_int_GDP}
    ...
    \input{tbl_did_heter_onsite_releases_int_LCI}
    ...
    \input{fig_did_heter_onsite_releases_int_LCI}
    ...
    \input{tbl_did_heter_onsite_releases_int_HLII}
    ...
    \input{fig_did_heter_onsite_releases_int_HLII}
    ...
    \input{tbl_did_heter_onsite_releases_int_CARCINOGENS}
    ...
    \input{tbl_did_heter_onsite_releases_int_CAA}
    ...
    \input{fig_did_heter_onsite_releases_int_CAA}
    ...
    \input{tbl_did_heter_onsite_releases_int_HAPs}
    ...
    \input{tbl_did_heter_onsite_releases_int_PBTs}
    ...
    \input{fig_did_heter_onsite_releases_int_PBTs}
    ...
    \input{tbl_did_mechanism_onsite_waste_mgt}
    ...
    \input{tbl_did_mechanism_onsite_sra}
    \input{tbl_did_mechanism_onsite_sra_matsub_prod}
    \input{tbl_did_mechanism_onsite_sra_process}
    \input{tbl_did_mechanism_onsite_sra_inventory_operations}
