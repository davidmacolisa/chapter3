...
%----------------------------------------------------------------------------------------------------------------------%
    ...
    \begin{itemize}
        ...
        \item \textit{Response:} I have shown the correlation matrix in Figure~\ref{fig:correlation-het} which shows no correlations across the main heterogeneous dimensions. Based on this, I have constructed dummies of high-profit-labour-intensive v. high-profit-capital-intensive manufacturing industries, and low-profit-labour-intensive v. low-profit-capital-intensive manufacturing industries. \input{fig_correlation_heter}
    \end{itemize}
%======================================================================================================================%
    \newpage
    \printbibliography
