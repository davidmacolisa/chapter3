...
\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{%
        \begin{tabular}{@{}llllllllllll@{}}
            \toprule\toprule
            Source Reduction Activities & \multicolumn{4}{c}{Material Substitution} & \multicolumn{4}{c}{Process Modification}   & \multicolumn{1}{c}{Operations Activities}   & \multicolumn{1}{c}{Inventory Management} \\
            \cmidrule(lr){3-5} \cmidrule(lr){6-9} \cmidrule(lr){10-10} \cmidrule(lr){11-11}
