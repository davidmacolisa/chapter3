...
fixest::etable(did_total_releases_catastrophicevents, agg = "ATT", digits = 3, digits.stats = 3)
fixest::etable(did_total_releases_catastrophicevents, agg = "cohort", digits = 3, digits.stats = 3)
