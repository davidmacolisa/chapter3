...
fixest::etable(did_total_releases)
...
fixest::etable(did_receiving_streams)
...
fixest::etable(did_land_releases)
...
fixest::etable(did_undground_inject)
...
fixest::etable(did_release_toland)
...
fixest::etable(did_surface_impoundment)
...
fixest::iplot(did_surface_impoundment, xlim = c(2011, 2017), ylim = c(-0.15, 0.15), col = "blue",
              main = "Total OnsiteSurface Impoundment Intensity", xlab = "relative year") %>%
  abline(v = 2013, col = "red", lty = 2, lwd = 2)
### Testing for pre-trends
...
fixest::etable(did_land_releases_others)
