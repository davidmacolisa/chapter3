...
iplot(did_releases, xlim = c(-3, 3), ylim = c(-0.1, 0.5), col = "blue",
...
etable(did_releases_unknown, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_releases_unknown, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_releases_unknown, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
...
#======================================================================================================================#
did_releases_wastebroker <- feols(
...
etable(did_releases_wastebroker, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_releases_wastebroker, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_releases_wastebroker, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
...
etable(did_releases_others, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_releases_others, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_releases_others, xlim = c(-3, 3), ylim = c(-0.2, 0.2), col = "blue",
...
#======================================================================================================================#
did_releases_metalsolidify <- feols(
...
etable(did_releases_metalsolidify, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_releases_metalsolidify, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_releases_metalsolidify, xlim = c(-3, 3), ylim = c(-0.2, 0.4), col = "blue",
...
etable(did_releases_storage, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_releases_storage, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_releases_storage, xlim = c(-3, 3), ylim = c(-0.1, 0.1), col = "blue",
...
par(mfrow = c(2, 3))
iplot(did_releases, xlim = c(-3, 3), ylim = c(-0.2, 0.6), col = "blue",
...
iplot(did_releases_wastebroker, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
	  ...
	  lwd = 1, cex = 4, pt.cex = 3, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(did_releases_others, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
	  main = "Total Offsite Releases Intensity, Others", xlab = "relative year",
	  lwd = 1, cex = 4, pt.cex = 3, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(did_releases_metalsolidify, xlim = c(-3, 3), ylim = c(-0.5, 0.5), col = "blue",
	  main = "Total Offsite Releases Intensity, Metal Solidification", xlab = "relative year",
	  lwd = 1, cex = 4, pt.cex = 3, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(did_releases_storage, xlim = c(-3, 3), ylim = c(-0.1, 0.1), col = "blue",
...
iplot(did_land_releases, xlim = c(-3, 3), ylim = c(-0.5, 0.5), col = "blue",
...
#======================================================================================================================#
did_land_releases_others <- feols(
...
etable(did_land_releases_others, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_land_releases_others, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_land_releases_others, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
...
#======================================================================================================================#
did_waste_water_releases <- feols(
...
etable(did_waste_water_releases, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_waste_water_releases, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_waste_water_releases, xlim = c(-3, 3), ylim = c(-0.2, 0.2), col = "blue",
...
etable(did_surface_impoundment, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_surface_impoundment, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_surface_impoundment, xlim = c(-3, 3), ylim = c(-0.01, 0.02), col = "blue",
...
etable(did_toland_treatment, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_toland_treatment, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_toland_treatment, xlim = c(-3, 3), ylim = c(-0.1, 0.1), col = "blue",
...
etable(did_landfills, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_landfills, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_landfills, xlim = c(-3, 3), ylim = c(-0.2, 0.4), col = "blue",
...
#======================================================================================================================#
did_underground_injection <- feols(
...
etable(did_underground_injection, agg = "ATT", digits = 3, digits.stats = 3)
etable(did_underground_injection, agg = "cohort", digits = 3, digits.stats = 3)
iplot(did_underground_injection, xlim = c(-3, 3), ylim = c(-0.15, 0.1), col = "blue",
