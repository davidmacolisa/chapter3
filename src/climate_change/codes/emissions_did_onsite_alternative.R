...
pre.treat.coef <- coef(did_total_releases)[grep(pattern = "treated", names(coef(did_total_releases)))]
pre.treat.coef <- pre.treat.coef[1:2]
linearHypothesis(did_total_releases, paste0(names(pre.treat.coef), " = 0"), test = "F")
#======================================================================================================================#
pdf(file = "./Thesis/chapter3/src/climate_change/latex/fig_alt_did_total_releases_onsite_int.pdf", width = 5, height = 4.5)
# par(mfrow = c(1, 2))
fixest::iplot(did_total_releases, xlim = c(2011, 2017), ylim = c(-0.5, 0.5), col = "blue",
              main = "Total Onsite Releases Intensity", xlab = "relative year",
              lwd = 1, cex = 4, pt.cex = 3, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1) %>%
...
did_air <- fixest::feols(
  l.total.air.emissions.onsite.intensity ~ treated * post +
    sw0(
      gdppc.1 +
        annual.avg.estabs.1 +
        cpi.1 +
...
fixest::iplot(did_air, xlim = c(2011, 2017), ylim = c(-0.4, 0.4), col = "blue",
  ...
  abline(v = 2013, col = "red", lty = 2, lwd = 2)
### Testing for pre-trends
pre.treat.coef <- coef(did_air)[grep(pattern = "treated", names(coef(did_air)))]
...
did_point_air <- fixest::feols(
  l.total.point.air.emissions.onsite.intensity ~ treated * post +
    sw0(
      gdppc.1 +
        annual.avg.estabs.1 +
        cpi.1 +
...
fixest::iplot(did_point_air, xlim = c(2011, 2017), ylim = c(-0.4, 0.4), col = "blue",
  ...
  abline(v = 2013, col = "red", lty = 2, lwd = 2)
### Testing for pre-trends
pre.treat.coef <- coef(did_point_air)[grep(pattern = "treated", names(coef(did_point_air)))]
pre.treat.coef <- pre.treat.coef[1:2]
...
did_fug_air <- fixest::feols(
  l.total.fug.air.emissions.onsite.intensity ~ treated * post +
    sw0(
      gdppc.1 +
        annual.avg.estabs.1 +
        cpi.1 +
...
fixest::iplot(did_fug_air, xlim = c(2011, 2017), ylim = c(-0.4, 0.4), col = "blue",
  ...
  abline(v = 2013, col = "red", lty = 2, lwd = 2)
### Testing for pre-trends
pre.treat.coef <- coef(did_fug_air)[grep(pattern = "treated", names(coef(did_fug_air)))]
pre.treat.coef <- pre.treat.coef[1:2]
linearHypothesis(did_fug_air, paste0(names(pre.treat.coef), " = 0"), test = "F")
#======================================================================================================================#
pdf(file = "../latex/fig_alt_did_onsite_air_emissions_int.pdf", width = 12, height = 4)
par(mfrow = c(1, 3))
fixest::iplot(did_air, xlim = c(2011, 2017), ylim = c(-0.4, 0.4), col = "blue",
              main = "Total Onsite Air Emissions Intensity", xlab = "relative year",
              lwd = 1, cex = 4, pt.cex = 3, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1) %>%
