...
triQs <- triQs %>%
  ...
  ungroup()
sum_up(triQs, c(low.skilled.workers, wage.perhr))
#======================================================================================================================#
### Profitability
...
rtp_50th_percentile <- quantile(triQs[triQs$year == 2011,]$revenue.to.profit, probs = 0.5)
ptr_50th_percentile <- quantile(triQs[triQs$year == 2011,]$payroll.to.revenue, probs = 0.5)
wtr_50th_percentile <- quantile(triQs[triQs$year == 2011,]$wages.to.revenue, probs = 0.5)
profit_50th_percentile <- quantile(triQs[triQs$year == 2011,]$profit, probs = 0.5)
...
triQs %>% sum_up(c(high.payroll.revenue, high.wages.revenue, high.profit, labour.intensive,
...
iplot(sdid_wages_highskilled, xlim = c(-3, 3), ylim = c(-0.2, 0.15), col = "blue",
...
iplot(sdid_wages_ci, xlim = c(-3, 3), ylim = c(-0.2, 0.1), col = "blue",
...
iplot(sdid_wages_lp, xlim = c(-3, 3), ylim = c(-0.2, 0.1), col = "blue",
...
iplot(sdid_pay_highskilled, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
...
iplot(sdid_pay_ci, xlim = c(-3, 3), ylim = c(-0.3, 0.35), col = "blue",
...
iplot(sdid_pay_hp, xlim = c(-3, 3), ylim = c(-0.3, 0.5), col = "blue",
...
iplot(sdid_pay_lp, xlim = c(-3, 3), ylim = c(-0.5, 0.2), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
#======================================================================================================================#
pdf(file = "./Thesis/chapter3/src/climate_change/latex/fig_sdid_industry_cost_heter_state.pdf", width = 20, height = 7)
par(mfrow = c(2, 6))
iplot(sdid_wages_lowskilled, xlim = c(-3, 3), ylim = c(-0.5, 0.7), col = "blue",
	  main = "Hourly wage (log), Low-skilled Workers", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T,
...
iplot(sdid_pay_ci, xlim = c(-3, 3), ylim = c(-0.3, 0.35), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_pay_hp, xlim = c(-3, 3), ylim = c(-0.3, 0.4), col = "blue",
	  main = "Total Payroll (log), High-Profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T,
	  ci.lwd = 5, ci.lty = 1
) %>%
...
iplot(sdid_emp_lowskilled, xlim = c(-3, 3), ylim = c(-1.8, 0.7), col = "blue",
...
iplot(sdid_emp_hp, xlim = c(-3, 3), ylim = c(-0.4, 0.4), col = "blue",
...
iplot(sdid_emp_lp, xlim = c(-3, 3), ylim = c(-0.6, 0.3), col = "blue",
...
iplot(sdid_prodworkers_highskilled, xlim = c(-3, 3), ylim = c(-0.4, 0.2), col = "blue",
...
iplot(sdid_prodworkers_ci, xlim = c(-3, 3), ylim = c(-0.4, 0.3), col = "blue",
...
iplot(sdid_prodworkers_hp, xlim = c(-3, 3), ylim = c(-0.3, 0.4), col = "blue",
...
iplot(sdid_prodworkers_lp, xlim = c(-3, 3), ylim = c(-0.5, 0.2), col = "blue",
...
iplot(sdid_prodhours_lowskilled, xlim = c(-3, 3), ylim = c(-1.8, 0.85), col = "blue",
...
iplot(sdid_prodhours_hp, xlim = c(-3, 3), ylim = c(-0.4, 0.4), col = "blue",
...
iplot(sdid_prodhours_lp, xlim = c(-3, 3), ylim = c(-0.6, 0.2), col = "blue",
	  main = "Production Hours (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
#======================================================================================================================#
pdf(file = "./Thesis/chapter3/src/climate_change/latex/fig_sdid_emp_hours_heter_state.pdf", width = 24, height = 11)
par(mfrow = c(3, 6))
iplot(sdid_emp_lowskilled, xlim = c(-3, 3), ylim = c(-1.8, 0.7), col = "blue",
	  main = "Employment (log), Low-skilled Workers", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T,
...
iplot(sdid_emp_lp, xlim = c(-3, 3), ylim = c(-0.5, 0.3), col = "blue",
	  main = "Employment (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
...
iplot(sdid_prodhours_hp, xlim = c(-3, 3), ylim = c(-0.4, 0.4), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_prodhours_lp, xlim = c(-3, 3), ylim = c(-0.6, 0.3), col = "blue",
	  main = "Production Hours (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
...
iplot(sdid_output_highskilled, xlim = c(-3, 3), ylim = c(-0.6, 0.5), col = "blue",
...
iplot(sdid_output_ci, xlim = c(-3, 3), ylim = c(-0.7, 0.4), col = "blue",
...
iplot(sdid_output_hp, xlim = c(-3, 3), ylim = c(-0.5, 0.7), col = "blue",
...
iplot(sdid_output_lp, xlim = c(-3, 3), ylim = c(-0.4, 0.4), col = "blue",
...
iplot(sdid_output_perhr_highskilled, xlim = c(-3, 3), ylim = c(-0.5, 0.55), col = "blue",
...
iplot(sdid_output_perhr_li, xlim = c(-3, 3), ylim = c(-0.5, 0.5), col = "blue",
...
iplot(sdid_output_perhr_ci, xlim = c(-3, 3), ylim = c(-0.5, 0.4), col = "blue",
...
iplot(sdid_output_perhr_lp, xlim = c(-3, 3), ylim = c(-0.2, 0.45), col = "blue",
...
iplot(sdid_output_perworker_highskilled, xlim = c(-3, 3), ylim = c(-0.5, 0.45), col = "blue",
...
iplot(sdid_output_perworker_ci, xlim = c(-3, 3), ylim = c(-0.6, 0.3), col = "blue",
...
iplot(sdid_output_perworker_lp, xlim = c(-3, 3), ylim = c(-0.3, 0.4), col = "blue",
	  main = "Output per worker (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
#======================================================================================================================#
pdf(file = "./Thesis/chapter3/src/climate_change/latex/fig_sdid_output_heter_state.pdf", width = 24, height = 11)
par(mfrow = c(3, 6))
iplot(sdid_output_lowskilled, xlim = c(-3, 3), ylim = c(-2.5, 2.5), col = "blue",
	  main = "Output (log), Low-skilled Workers", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_highskilled, xlim = c(-3, 3), ylim = c(-0.6, 0.4), col = "blue",
	  main = "Output (log), High-skilled Workers", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_li, xlim = c(-3, 3), ylim = c(-0.6, 0.7), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_ci, xlim = c(-3, 3), ylim = c(-0.6, 0.4), col = "blue",
	  main = "Output (log), Capital-intensive ", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_hp, xlim = c(-3, 3), ylim = c(-0.5, 0.8), col = "blue",
	  main = "Output (log), High-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_lp, xlim = c(-3, 3), ylim = c(-0.3, 0.3), col = "blue",
	  main = "Output (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
...
iplot(sdid_output_perhr_li, xlim = c(-3, 3), ylim = c(-0.4, 0.5), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_perhr_ci, xlim = c(-3, 3), ylim = c(-0.5, 0.3), col = "blue",
	  main = "Output per hour (log), Capital-intensive", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
...
iplot(sdid_output_perworker_lowskilled, xlim = c(-3, 3), ylim = c(-0.8, 1.8), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_perworker_highskilled, xlim = c(-3, 3), ylim = c(-0.6, 0.45), col = "blue",
	  main = "Output per worker (log), High-skilled Workers", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
...
iplot(sdid_output_perworker_hp, xlim = c(-3, 3), ylim = c(-0.65, 0.65), col = "blue",
  ...
  abline(v = -1, col = "red", lty = 2, lwd = 2)
iplot(sdid_output_perworker_lp, xlim = c(-3, 3), ylim = c(-0.2, 0.4), col = "blue",
	  main = "Output per worker (log), Low-profit", xlab = "relative year", lwd = 1, cex = 4,
	  pt.cex = 1.5, pt.col = "red", pt.join = T, ci.lwd = 5, ci.lty = 1
) %>%
  abline(v = -1, col = "red", lty = 2, lwd = 2)
