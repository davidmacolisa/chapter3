...
bdsm$name <- sub(", Alabama", "", bdsm$name)
bdsm$name <- sub(", Alaska", "", bdsm$name)
bdsm$name <- sub(", Arizona", "", bdsm$name)
bdsm$name <- sub(", Arkansas", "", bdsm$name)
bdsm$name <- sub(", California", "", bdsm$name)
bdsm$name <- sub(", Colorado", "", bdsm$name)
bdsm$name <- sub(", Connecticut", "", bdsm$name)
bdsm$name <- sub(", Delaware", "", bdsm$name)
bdsm$name <- sub(", Florida", "", bdsm$name)
bdsm$name <- sub(", Georgia", "", bdsm$name)
bdsm$name <- sub(", Hawaii", "", bdsm$name)
bdsm$name <- sub(", Idaho", "", bdsm$name)
bdsm$name <- sub(", Illinois", "", bdsm$name)
bdsm$name <- sub(", Indiana", "", bdsm$name)
bdsm$name <- sub(", Iowa", "", bdsm$name)
bdsm$name <- sub(", Kansas", "", bdsm$name)
bdsm$name <- sub(", Kentucky", "", bdsm$name)
bdsm$name <- sub(", Louisiana", "", bdsm$name)
bdsm$name <- sub(", Maine", "", bdsm$name)
bdsm$name <- sub(", Maryland", "", bdsm$name)
bdsm$name <- sub(", Massachussetts", "", bdsm$name)
bdsm$name <- sub(", Michigan", "", bdsm$name)
bdsm$name <- sub(", Minnesota", "", bdsm$name)
bdsm$name <- sub(", Mississippi", "", bdsm$name)
bdsm$name <- sub(", Missouri", "", bdsm$name)
bdsm$name <- sub(", Montana", "", bdsm$name)
bdsm$name <- sub(", Nebraska", "", bdsm$name)
bdsm$name <- sub(", Nevada", "", bdsm$name)
bdsm$name <- sub(", New Hampshire", "", bdsm$name)
bdsm$name <- sub(", New Jersey", "", bdsm$name)
bdsm$name <- sub(", New Mexico", "", bdsm$name)
bdsm$name <- sub(", New York", "", bdsm$name)
bdsm$name <- sub(", North Carolina", "", bdsm$name)
bdsm$name <- sub(", North Dakota", "", bdsm$name)
bdsm$name <- sub(", Ohio", "", bdsm$name)
bdsm$name <- sub(", Oklahoma", "", bdsm$name)
bdsm$name <- sub(", Oregon", "", bdsm$name)
bdsm$name <- sub(", Pennsylvania", "", bdsm$name)
bdsm$name <- sub(", Rhode Island", "", bdsm$name)
bdsm$name <- sub(", South Carolina", "", bdsm$name)
bdsm$name <- sub(", South Dakota", "", bdsm$name)
bdsm$name <- sub(", Tennessee", "", bdsm$name)
bdsm$name <- sub(", Texas", "", bdsm$name)
bdsm$name <- sub(", Utah", "", bdsm$name)
bdsm$name <- sub(", Vermont", "", bdsm$name)
bdsm$name <- sub(", Virginia", "", bdsm$name)
bdsm$name <- sub(", Washington", "", bdsm$name)
bdsm$name <- sub(", West Virginia", "", bdsm$name)
bdsm$name <- sub(", Wisconsin", "", bdsm$name)
bdsm$name <- sub(", Wyoming", "", bdsm$name)
